...
export default function Contact() {
  ...
  return (
    <div>
      <PageHeader title="contact" subtitle="Have a question, suggestion, or just want to say hello?" />

      <Card className="p-6">
        <div className="space-y-4">
          <Field label="NAME">
            <input value={name} onChange={(e) => setName(e.target.value)} className="w-full rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 px-3.5 py-2.5 text-sm outline-none focus:border-brand-400" />
          </Field>
          <Field label="EMAIL">
            <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" className="w-full rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 px-3.5 py-2.5 text-sm outline-none focus:border-brand-400" />
          </Field>
          <Field label="MESSAGE">
            <textarea
              value={message}
              ...
              rows={5}
              className="w-full resize-none rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 px-3.5 py-2.5 text-sm outline-none focus:border-brand-400"
            />
