...
const ICONS: Record<NotificationType, any> = {
  people: Users, community: Users, mention: AtSign, like: Heart, reply: MessageSquare, event: CalendarClock,
}
const LABELS: Record<NotificationType, string> = {
  people: 'People', community: 'Community', mention: 'Mention', like: 'Like', reply: 'Reply', event: 'Event',
}
              ...
              <Card key={n.id} className="flex items-start gap-3 p-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex gap-2">
                    {refHandle[n.id] && (
                      <Link href={`/dashboard/profile/${refHandle[n.id]}`}>
