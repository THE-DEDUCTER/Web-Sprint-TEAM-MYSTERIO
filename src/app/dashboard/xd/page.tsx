...
export default function XD() {
  ...
  if (!item) {
    return (
      <div>
        <PageHeader title="xd" subtitle="Anonymous exchange feed." />
        <div className="flex h-64 items-center justify-center text-sm text-neutral-400">Loading XD…</div>
      </div>
    )
  }
  ...
  return (
    <div>
      <PageHeader title="xd" subtitle="Anonymous exchange feed." />
      <div className="fixed inset-0 flex items-center justify-center bg-black lg:left-16 xl:right-[280px]" style={{ top: '0', zIndex: 10 }}>
