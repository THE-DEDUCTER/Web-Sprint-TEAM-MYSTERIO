...
import { ArrowLeft, Share2, UserPlus, Users, Info, ExternalLink, Sparkles } from 'lucide-react'
...
export default function CommunityDetail() {
  ...
  return (
    <div>
      <button onClick={() => router.push('/dashboard/communities')} className="mb-4 flex items-center gap-1.5 text-sm text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200">
      ...
      <Card className="mt-5 flex items-start gap-2.5 bg-blue-50/60 dark:bg-blue-950/30 p-4 border-blue-100 dark:border-blue-900">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300">
          Are you a club lead? Contact the developers via the{' '}
          <Link href="/dashboard/contact" className="font-semibold underline">contact form</Link>{' '}
          to get started.
        </p>
      </Card>
